    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // ⚠️ 1. LA SCACCHIERA (Usa lo spazio disponibile in alto)
          Expanded(
            flex: 10,
            child: Center(
              child: Padding(
          ...
          // ⚠️ 2. PANNELLO IMPOSTAZIONI (Usa lo spazio disponibile in basso)
          Expanded(
            flex: 12,
            child: Container(
              ...
              child: Column(
                children: [
                  // --- A. ZONA SCORREVOLE (IMPOSTAZIONI) ---
                  Expanded(
                  ...
                  // --- B. ZONA BOTTONI FISSI IN BASSO (PINNATI) ---
                  const SizedBox(height: 12),
                  if (state.isPlaying) ...[
                    Row(
                      children: [
