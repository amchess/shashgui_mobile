    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.star), label: loc.premium),
        ],
      ),
    );
  }
...
class _EngineTestScreenState extends State<EngineTestScreen> {
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
              ...
              PopupMenuItem<String>(
                value: 'en',
                child: Text(loc.english, style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
                                ...
                                child: TextButton.icon(
                                  onPressed: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          loc.funzioneTrattiPosizionaliBlocc,
                                        ),
                                      ),
                                    );
                                  },
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          items: [
                            DropdownMenuItem(
                              value: 'shashchess',
                              child: Text(loc.shashchess),
                            ),
                            DropdownMenuItem(
                              value: 'alexander',
                              child: Text(loc.alexander),
                            ),
                          ],
                          ...
                          onPressed: () {
                            if (_isEngineRunning) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    loc.spegniIlMotorePerModificareIPa,
                                  ),
                                ),
                              );
                            } else {
                        ...
                        if (_isEngineRunning) ...[
                          ...
                          IconButton(
                            ...
                            tooltip: loc.giocaControIlMotore,
                          ),
                          IconButton(
                            ...
                            tooltip: loc.autoplayMotoreVsMotore,
                          ),
                          IconButton(
                          ...
                          IconButton(
                            ...
                            tooltip: loc.valutazioneIncrociata,
                          ),
                        ],
                      ],
                    ),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(loc.annulla, style: TextStyle(color: Colors.grey)),
          ),
          ElevatedButton(
            onPressed: () {
            ...
            child: Text(loc.importa, style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
  ...
  void _loadPgnGame(String pgn) {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(loc.partitaCaricataConSuccesso),
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                tooltip: loc.importaLinkLichessIncollaPgn,
              ...
              IconButton(
                ...
                tooltip: loc.salvaPartitaInLocale,
              ...
              IconButton(
                ...
                tooltip: loc.copiaPgnInMemoria,
                onPressed: () {
                  String pgn = _boardController.game.pgn();
                  Clipboard.setData(ClipboardData(text: pgn));
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(loc.pgnCopiatoNegliAppunti)),
                  );
                },
              ),
            ],
    ...
    return showDialog<String>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: const Color(0xFF2b2b2b),
          title: Text(
            loc.diramazioneRilevata,
            style: TextStyle(color: Colors.orangeAccent),
          ),
          content: Text(loc.esisteGiUnaContinuazionePerQue),
  ...
  void _showImportDialog() async {
    ...
    if (newFen != null && newFen.isNotEmpty) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(loc.erroreLaScacchieraNonHaPotutoV)),
        );
      }
    }
  }
            ...
            children: [
              ...
              Expanded(
                child: _engineOptionsMetadata.isEmpty
                    ? Center(
                        // <-- TOLTO IL CONST QUI!
                        child: Text(loc.nessunaOpzioneTrovataOCaricame),
                      )
                    : ListView.builder(
  ...
  void _scanThreats() async {
    ...
    if (_boardController.game.in_check) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(loc.impossibileAnalizzareLeMinacce)),
      );
      return;
    }
    ...
    if (currentFen.contains("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w")) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(loc.nessunaMinacciaAllaMossaInizia)),
      );
      return;
    }
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            ...
                            onTap: () =>
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text(loc.esclusivaPremium)),
                                ),
                          ),
                        ],
                      ),
...
class PremiumShowcaseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(loc.shashguiPremium),
        backgroundColor: const Color(0xFF1e1e1e),
        centerTitle: true,
      ),
      body: ListView(
      ...
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              isLoaded ? loc.beyondTheEval : "Beyond the eval",
              style: TextStyle(
                fontSize: 13,
                fontStyle: FontStyle.italic,
                color: Colors.cyanAccent,
